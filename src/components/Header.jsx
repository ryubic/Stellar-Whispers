  ...
  return (
    <>
      <div className='py-[10px] z-10 sm:py-0 sm:h-[80px] box-border px-[7vw] sm:px-[5vw] w-screen bg-[#1c1d22] text-gray-300 sticky top-0 sm:static flex justify-between items-center text-xl select-none'>
        <h1 className='text-gray-300 text-3xl sm:text-4xl font-onest font-bold cursor-default'>Stellar Whispers</h1>
        <div className='flex gap-4 sm:text-base font-onest'>
          ...
          <button
            ...
            <span className={`w-8 border-b-4 border-orange-500 transition-all duration-300 ${navVisibility ? "rotate-45 translate-y-2" : ""}`}></span>
